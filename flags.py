...
data = pd.read_csv("flagdex.csv", delimiter=',')
...
class Pokemon:
    def __init__(self, nam, dexnum, gen, typeone, typetwo, stagefirst, stagelast, leg, mythic, abilone, abiltwo, hidabil, mid, flag):
...
def createentry():
    ...
    while counter < monamount:
        newmon = Pokemon(names[counter], dexnumber[counter], gen[counter], primarytype[counter], secondarytype[counter], firststage[counter], fullyevolved[counter], legendary[counter], mythical[counter], ability1[counter], ability2[counter], abilityhidden[counter], middlevo[counter], flags[counter])
        counter += 1
        dex.append(newmon)
...
leaveresultbut = Button(100, 50, 110, 60, "Menu", [3*screen.get_width()/7 - 50, 400, 100, 50], [3*screen.get_width()/7 -55, 395, 110, 60], 'results', 'tomenu')
allbuttons.append(leaveresultbut)
rerunbut = Button(100, 50, 110, 60, "Refine search", [5*screen.get_width()/7 - 50, 400, 100, 50], [5*screen.get_width()/7 - 55, 395, 110, 60], 'results', 'rerun')
backbut = Button(100, 50, 110, 60, "Previous", [screen.get_width()/7 - 50, 400, 100, 50], [screen.get_width()/7 - 55, 395, 110, 60], 'results', 'resultback')
forbut = Button(100, 50, 110, 60, "Next", [6*screen.get_width()/7 - 50, 400, 100, 50], [6*screen.get_width()/7 - 55, 395, 110, 60], 'results', 'resultforward')
wipebut = Button(100, 50, 110, 60, "Clear results", [2*screen.get_width()/7 - 50, 400, 100, 50], [2*screen.get_width()/7 - 55, 395, 110, 60], 'results', 'clear')
...
while not game_over:
    ...
    if currentscreen == 'menu':
        ...
        screen.blit(subhead_font.render('be unflagged.', True, text_colour), (5, 185))
        ...
        if filterstep == 'initialinput':
            ...
            if whichfilter == 'myth' or whichfilter == 'legend' or whichfilter == 'flag':
                filterstep = 'processinputtwo'
            screen.blit(subhead_font.render('Which trait would you like to filter by?', True, text_colour), ((5, 60)))
            screen.blit(underline, (5, 112))
            screen.blit(subhead_font.render(initinpu, True, text_colour), (5, 90))
